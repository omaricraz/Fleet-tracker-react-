        ...
        <tbody className="divide-y divide-border/60">
          {rows.map((row) => (
            ...
            >
              ...
              <td className="px-4 py-5 text-sm text-muted-foreground sm:px-6">{row.type}</td>
              <td className="px-4 py-5 text-sm font-semibold text-foreground sm:px-6">{row.price}</td>
              <td className="px-4 py-5 text-sm text-muted-foreground sm:px-6">{row.unitWeight}</td>
              <td className="px-4 py-5 text-sm text-muted-foreground sm:px-6">{row.unitVolume}</td>
